...
// Admin
export const createCategory = (category: Omit<CategoryDto, "id">): Promise<CategoryDto> =>
    instance.post("/categories", category).then(r => r.data);

export const updateCategory = (id: number, category: Omit<CategoryDto, "id">): Promise<CategoryDto> =>
